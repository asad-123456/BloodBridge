...
class BloodRequest(Base):
    ...
    # donor typed; hospital_id is only set if that name matched a
    ...
    donor = relationship("Donor", back_populates="blood_requests")
    ...
    __table_args__ = (
        ...
        Index("ix_blood_requests_donor_id", "donor_id"),

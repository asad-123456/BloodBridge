...
export function RequestVerificationDetail() {
  ...
  const request = requests.find((item) => item.id === id && facility?.id && item.hospitalId === facility.id);
